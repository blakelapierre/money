...
const QuoteBalance = ({quoteBalance}) => (
  <quote-balance>
    <Bar direction="vertical" value={quoteBalance / totalQuoteValue} />
  </quote-balance>
);

const Bar = ({direction, value}) => (
  d = direction === 'vertical' ? 'height' : 'width',
  <bar style={{[d]: `${value * 100)%` }} />
);
