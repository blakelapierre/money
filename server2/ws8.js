...
var http_port = process.env.http_port || 8187;
var ws_port = process.env.ws_port || 8188;
         ...
         .then(result => {
           for (let i = 0; i < os.length; i++) {
             if (o === os[i]) {
               ...
               managers[ticker].sendState(sendMessageToWSockets);
